<template>
  ...
  <el-card style="width: 100%" shadow="never">
    ...
    <div style="height: 60px;">
      <el-space :size="20">
        <el-button type="primary" :icon="CirclePlus" v-permission="`system:dict:add`" @click="handlerAddDictOpen">
          新增
        </el-button>
        <el-popconfirm title="确认批量删除？" confirm-button-text="确定" cancel-button-text="取消" @confirm="handlerBatchDelete">
          <template #reference>
            <el-button :disabled="disabled" type="danger" :icon="Delete" v-permission="`system:dict:delete`">
              批量删除
            </el-button>
          </template>
        </el-popconfirm>
    ...
    <el-table @selection-change="handleSelectionChange" :data="tableData" v-loading="loading" style="width: 100%">
      ...
      <el-table-column fixed="right" label="选项" width="180">
        <template #default="scope">
          <el-button v-permission="`system:dict:update`" link :icon="Edit" type="primary"
          ...
          <el-popconfirm title="确认删除该字典类型？" confirm-button-text="确定" cancel-button-text="取消"
            ...
            <template #reference>
              <el-button v-permission="`system:dict:delete`" link :icon="Delete" type="danger">删除</el-button>
            </template>
          </el-popconfirm>
        </template>
      </el-table-column>
